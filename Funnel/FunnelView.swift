...
class FunnelView: UIView {
    ...
    override func drawRect(rect: CGRect) {
        ...
        //        let circleLUBtn = UIButton(frame: CGRectMake(20, 100, 100, 100))
        //        let circleRUBtn = UIButton(frame: CGRectMake(160, 100, 100, 100))
        //        let circleLDBtn = UIButton(frame: CGRectMake(20, 250, 100, 100))
        //        let circleRDBtn = UIButton(frame: CGRectMake(160, 250, 100, 100))
        //
        //
