...
class FunnelDetailViewController: BaseTweetViewController, CustomTweetTableViewCellDelegate {
    ...
    override func loadMore(cb: ()->(), errcb: ()->()) {
        ...
        let hashtagOne = SettingStore.sharedInstance.getfunnelNameOne()
        if hashtagOne == nil || hashtagOne == "" {
